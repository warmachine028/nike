                  ...
                  <div  className={'flex justify-center flex-col align-center'}>
                      ...
                      <div className={'flex justify-center align-start flex-col mb-8'}>
                          ...
                          <p className={'text-base font-medium text-gray-400 text-left mt-2 w-96  max-sm:w-full'}>
                              Threadborne™ upper delivers lightweight directional strength to support the games most
                      ...
                      <div className={'flex justify-center align-start flex-col mt-6'}>
                          ...
                          <div className={'flex align-start flex-row gap-3'}>
                              ...
                              <div  className={'flex justify-center align-center w-7 h-7 border-2 border-gray-300 text-gray-400 hover:cursor-pointer'}>9</div>
                              <div  className={'flex justify-center align-center w-7 h-7 border-2 border-gray-300 text-gray-400 hover:cursor-pointer'}>10</div>
                              <div  className={'flex justify-center align-center w-7 h-7 border-2 border-gray-300 text-gray-400 hover:cursor-pointer'}>11</div>
                          </div>
                      </div>
