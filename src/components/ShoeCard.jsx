const ShoeCard = ({ img, change, largeImg }) => {
	...
	return (
		<div
			className={`border-2 rounded-xl hover:scale-110 duration-300 transition ease-in-out ${largeImg === img.bigShoe ? "border-coral-red" : "border-transparent"} cursor-pointer max-sm:flex-1`}
			onClick={handleClick}
		>
			<div
