			...
			<div id="about-us" className="max-container max-sm:mt-12 flex justify-between  max-lg:flex-col gap-10 w-full">
				<div className="flex flex-1 flex-col">
					...
					<p className="mt-4 lg:max-w-lg info-text">
						Ensuring premium comfort and style, out meticulously crafted footwear is designed to elevate your experience, providing you with unmatched quality, innovation, and a touch of
						elegance.
					</p>
